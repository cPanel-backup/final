...
//Admin Settings
define('Version', '1.322'); //If any Update In website like style, images, Increase Version Number
define('DomainId', '1'); //Keep Domain id '1'(Respective Domain ID) or 'NO'
define('Domain', 'Trigotab'); //Keep Respective Domain Name 
define('Favicon', 'True'); //True or False
//define('Analytics', 'False'); //True or False


//Email Settings
define('EmailAPI', 'http://services.heterohcl.com/SMTP_EMAIL/');//SendTestEmails
define('EmailSignature', '<strong>Thanks & Regards</strong><br> Support Team, <br>Hetero Healthcare Limited.');
...
define('Copyright', '<a href="https://www.heterohealthcare.com" target="_blank">Hetero Healthcare Limited</a>');